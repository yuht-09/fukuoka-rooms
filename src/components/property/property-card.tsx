...
export function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <div className="group relative rounded-xl overflow-hidden border border-border bg-card hover:border-primary/30 transition-all duration-300 hover:scale-[1.02]">
      <Link href={`/rooms/${property.id}`} className="block">
        ...
        <div className="relative aspect-[4/3] bg-secondary overflow-hidden">
          ...
          {/* Rent overlay on image bottom */}
          <div className="absolute bottom-3 left-3">
            <span className="text-lg font-bold font-[family-name:var(--font-inter)] text-white drop-shadow-lg">
